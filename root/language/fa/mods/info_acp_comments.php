...
$lang = array_merge($lang, array(
	...
	'COMMENTS_LIMIT_EXPLAIN'		=> 'به طور پیشفرض به همین تعداد دیدگاه نمایش داده خواهد شد و اگر بر روی "بارگذاری دیدگاه بیشتر" کلیک شود. همین تعداد دیدگاه به تعداد قبلی اضافه خواهد شد.س',
